...
test:
	emacs --batch -Q -L . -L test -l ert -l reka-tests.el -l reka-tests-functional.el -f ert-run-tests-batch-and-exit

test-interactiv:
	emacs -nw -Q -L . -L test -l ert -l reka-tests.el -l reka-tests-functional.el --eval="(ert t)" -f delete-other-windows
